...
__all__ = ["WeightMatrixAnime", "animate_weight_heatmap"]
...
class WeightMatrixAnime(Scene):
    ...
    def construct(self):
        ...
        def create_grid(matrix_data):
            ...
            return grid.center().shift(
                LEFT * 1.5
            )  # Shift left to make room for color bar
...
def animate_weight_heatmap(
    matrix_stack,
    dt=0.2,
    resolution=(1080, 1080),
    file_name="weight_animation",
    title_str="",
):
